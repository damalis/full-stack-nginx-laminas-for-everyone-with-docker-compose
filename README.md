# [full stack nginx Laminas for everyone with docker compose](https://github.com/damalis/full-stack-nginx-laminas-for-everyone-with-docker-compose)

If You want to build a website with Laminas at short time;

#### Full stack Nginx Laminas:
[![Laminas](https://img.shields.io/badge/Laminas-Framework-007ec6?logo=php&logoColor=white)](https://getlaminas.org/)
...
The containers are now built and running. You should be able to access the Laminas installation with the configured IP in the browser address. `https://DOMAIN_NAME`.
